...
namespace TheRace.Tests
{
    ...
    public class RaceEntryTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => this.race.AddRider(null));
        }

        [Test]
        public void Test_Add_Rider()
        {
            Assert.AreEqual("Rider Name1 added in ra.", this.race.AddRider(this.UnitRider1));
            Assert.AreEqual(1, this.race.Counter);
        }

        [Test]
        public void Test_Calculate_Average_Not_Enough_Riders()
        {

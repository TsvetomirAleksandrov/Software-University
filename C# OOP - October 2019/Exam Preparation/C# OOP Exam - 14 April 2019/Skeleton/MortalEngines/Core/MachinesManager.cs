...
namespace MortalEngines.Core
{
    ...
    public class MachinesManager : IMachinesManager
    {
        ...
        public string ToggleFighterAggressiveMode(string fighterName)
        {
            ...
            IFighter fighter =
                (Fighter) this.machines.FirstOrDefault(
                    m => m.Name == fighterName && m.GetType().Name == nameof(Fighter));
        ...
        public string ToggleTankDefenseMode(string tankName)
        {
            ...
            ITank tank =
                (Tank) this.machines.FirstOrDefault(m => m.Name == tankName && m.GetType().Name == nameof(Tank));
